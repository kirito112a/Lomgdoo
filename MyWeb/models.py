...
class product_and_service (models.Model):
    ...
    product_option_gender = models.CharField(max_length=100,null=True)
    product_option_province  = models.CharField(max_length=100,null=True)
    ...
    def __str__(self):
        return str(self.product_and_service_id)
...
class trial (models.Model):
    ...
    #trial_number = models.CharField (max_length=255)
    enturpreneur = models.ForeignKey(enturpreneur, on_delete=models.CASCADE , null=True)
...
class answer(models.Model):
   ...
   answer_number = models.FloatField(null =True) 
